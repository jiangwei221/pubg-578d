...
def set(training):
    ...
    if training:
        ...
        parser.add_argument('--max_iter', type=int, default=150000, help='total training iterations')
        parser.add_argument('--valid_iter', type=int, default=10000, help='iterval of validation')
