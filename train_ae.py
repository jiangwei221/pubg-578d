...
def main():
    ...
    pubg_train_loader = DataLoader(pubg_data, batch_size=opt.batch_size, num_workers=0, sampler=SubsetRandomSampler(train_indices))
    pubg_valid_loader = DataLoader(pubg_data, batch_size=opt.batch_size, num_workers=0, sampler=SubsetRandomSampler(valid_indices))
